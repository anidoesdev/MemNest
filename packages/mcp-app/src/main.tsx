...
import '../../../apps/dashboard/src/styles.css';
import './overrides.css';
import { McpDashboard, type HostState } from './McpDashboard';

const app = new App({ name: 'Memnest dashboard', version: '0.1.0' }, {}, { autoResize: true });
...
createRoot(document.getElementById('root')!).render(<McpDashboard app={app} host={host} />);
